...
<footer class="bg-surface-container-highest mt-12 py-20">
  <div class="max-w-7xl mx-auto px-8 grid grid-cols-1 md:grid-cols-12 gap-12">
    ...
    <div class="md:col-span-4 space-y-4">
      ...
      >
        ...
        />
        <button
          class="cursor-pointer bg-primary text-white px-4 py-2 rounded-lg font-label font-bold text-xs uppercase tracking-wider"
          >Join</button
        >
      </div>
    </div>
