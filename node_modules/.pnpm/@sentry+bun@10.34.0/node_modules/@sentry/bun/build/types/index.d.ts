export type { Breadcrumb, BreadcrumbHint, PolymorphicRequest, RequestEventData, SdkInfo, Event, EventHint, ErrorEvent, Exception, Session, SeverityLevel, Span, StackFrame, Stacktrace, Thread, User, FeatureFlagsIntegration, Metric, ExclusiveEventHintOrCaptureContext, CaptureContext, } from '@sentry/core';
