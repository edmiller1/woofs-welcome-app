...
<nav
  class="fixed bottom-0 w-full z-50 bg-white md:hidden rounded-t-3xl shadow-[0_-4px_24px_rgba(28,28,25,0.04)] flex justify-around items-center px-2 pb-6 pt-3"
>
