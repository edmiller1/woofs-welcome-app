...
<footer class="border-t">
  <div
    class="w-full mx-auto space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8"
  >
    ...
    >
      ...
      <div>
        <p class="font-medium text-gray-900">Advertise</p>
      </div>
    </div>
    <p class="text-xs text-gray-500">
      © {new Date().getFullYear()}. Woofs Welcome. All rights reserved.
    </p>
  </div>
</footer>
