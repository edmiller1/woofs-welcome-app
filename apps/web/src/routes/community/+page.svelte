...
<main class="pt-24 pb-32 max-w-7xl mx-auto px-6">
  ...
  <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-24">
    ...
    <div class="lg:col-span-2 space-y-8">
      ...
      <!-- TODO: Replace to review-card.svelte -->
      <div
        class="bg-surface-container-lowest p-6 rounded-4xl shadow-sm border border-outline-variant/10"
      >
        <div class="flex justify-between items-start mb-4">
          ...
          <div class="flex items-center gap-3">
            <div class="text-right">
              <p class="text-xs font-bold text-primary">Azure Bay Dog Beach</p>
        ...
        <p class="text-sm text-secondary mb-4 leading-relaxed">
          ...
          coffee truck on weekends. Barnaby absolutely loved meeting the other
          pups here!"
        </p>
        <div
      ...
      >
        <div class="flex justify-between items-start mb-4">
          ...
          <div class="flex items-center gap-3">
            <div class="text-right">
              <p class="text-xs font-bold text-primary">Whispering Pine Loop</p>
              <p class="text-[10px] text-secondary">
        ...
        <p class="text-sm text-secondary mb-4 leading-relaxed">
          "Just finished the High Ridge Summit. The views are unmatched! Note
          that the creek is dry this time of year, so pack accordingly."
        </p>
        <div
          class="inline-block bg-secondary-container/30 text-secondary text-[10px] font-bold px-3 py-1 rounded-full uppercase tracking-wider"
        >
        ...
        >
          <div class="flex items-center gap-4">
            ...
            <div>
              ...
              <p class="text-[10px] text-secondary">Peak District • 6:30 AM</p>
            </div>
          </div>
        ...
        >
          <div class="flex items-center gap-4">
            ...
            <div>
              ...
              <p class="text-[10px] text-secondary">Greenwich Park • 2:00 PM</p>
            </div>
          </div>
          <ChevronRight class="size-4" />
        </div>
